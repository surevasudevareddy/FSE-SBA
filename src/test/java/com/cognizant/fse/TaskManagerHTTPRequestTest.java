...
public class TaskManagerHTTPRequestTest {
	...
	public void optionsTest()throws Exception{
		Set<HttpMethod> optionsForAllow = restTemplate.optionsForAllow("http://localhost:"+port+"/taskManagerService/");
	...
	public void greetingTextShouldReturndefaultMsg()throws Exception{
		assertThat(restTemplate.getForObject("http://localhost:"+port+"/taskManagerService/Vasu", String.class)).contains("Hello Vasu!");
	}
	
	@Test
	public void getUsersShouldReturnNotEmpty()throws Exception{
		assertThat(restTemplate.getForObject("http://localhost:"+port+"/taskManagerService/getUsers", List.class)).isNotEmpty();;
	}
	@Test
	public void postNewUser()throws Exception{
		User user = new User(0,"Bill","Price","EMP1001");
		final String baseUrl = "http://localhost:"+port+"/taskManagerService/createUser";
	...
	public void updateExistingUser()throws Exception{
		...
		final String baseUrl = "http://localhost:"+port+"/taskManagerService/updateUser";
		URI uri = new URI(baseUrl);
		HttpEntity<User> request = new HttpEntity<>(user);
	...
	public void deleteExistingUser()throws Exception{		
		final String baseUrl = "http://localhost:"+port+"/taskManagerService/deleteUser/1";
		URI uri = new URI(baseUrl);		
	...
	public void postNewProject()throws Exception{
		...
		final String baseUrl = "http://localhost:"+port+"/taskManagerService/createProject?userId=1";
		URI uri = new URI(baseUrl);
	...
	public void getProjectsShouldReturnNotEmpty()throws Exception{
		assertThat(restTemplate.getForObject("http://localhost:"+port+"/taskManagerService/getProjects", List.class)).isNotEmpty();;
	}
	@Test
	public void updateNewProjects()throws Exception{
		User user = new User(1,"Bill","Sheere","EMP1001");
		Project project = new Project(1,"GREEN",new Date(),new Date(),1,user,2,2);
		final String baseUrl = "http://localhost:"+port+"/taskManagerService/updateProject?userId=1";
		URI uri = new URI(baseUrl);
		HttpEntity<Project> request = new HttpEntity<>(project);
	...
	public void postNewParentTask()throws Exception{
		...
		final String baseUrl = "http://localhost:"+port+"/taskManagerService/createParentTask";
		URI uri = new URI(baseUrl);
	...
	public void postNewTask()throws Exception{
		...
		final String baseUrl = "http://localhost:"+port+"/taskManagerService/createTask?parentId=1&projectId=1&userId=1";
		URI uri = new URI(baseUrl);
	...
	public void updateNewTask()throws Exception{
		...
		final String baseUrl = "http://localhost:"+port+"/taskManagerService/updateTask?parentId=1&projectId=1&userId=1";
		URI uri = new URI(baseUrl);
		HttpEntity<Task> request = new HttpEntity<>(task);
	...
	public void getTasksShouldReturnNotEmpty()throws Exception{
		assertThat(restTemplate.getForObject("http://localhost:"+port+"/taskManagerService/getTasks", List.class)).isNotEmpty();;
	}
	@Test
	public void getTaskByTaskId()throws Exception{
		assertThat(restTemplate.getForObject("http://localhost:"+port+"/taskManagerService/getTaskById?taskId=1", Task.class)).isNotNull();;
	}
	@Test
	public void getTaskByProjectId()throws Exception{
		assertThat(restTemplate.getForObject("http://localhost:"+port+"/taskManagerService/getTasksByPorjectId?projectId=1", List.class)).isEmpty();;
	}
}
